...
```{r zip_data, message = F, warning = F}
...
We read in anonymized data (see `preregisteration_112118_process_raw_data.R` for criterion applied to drop certain columns for privacy reasons)
```{r, message = F, warning = F}
data_new <- read_csv("data/11212018_people_novel_habit_anonymized_data.csv") 
...
new_filtered_data %>%
  group_by(gender, age_bin, politics_bin, dense) %>%
