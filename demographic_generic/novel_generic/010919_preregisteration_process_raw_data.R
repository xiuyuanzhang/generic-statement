...
raw_data <- read_csv('data/01102019qualtrics_novel_people_habits.csv') 
turk_data <- read_csv('data/01102019mturk_novel_people_habits.csv')
...
write_csv(de_identified_data, "data/01102019_people_novel_habit_anonymized_data.csv")
