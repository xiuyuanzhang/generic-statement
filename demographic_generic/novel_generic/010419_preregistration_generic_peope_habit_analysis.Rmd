...
samples <- replicate(1000, cor_sample())
...
For every possible subset of questions
  Do the by_q correlation to get a split_half reliability for each question
  t-test those
  return (t-value, pvalue)
